...
export function timeagoFormat(date,currDate) {
    invariant(date,'date can not be null');
    ...
    if(typeof date==='string'){
        invariant(regexDate.test(date),'date string is not date type');
    }
    if(typeof date==='number'){
        invariant(regexNumber.test(date),'date number is not date type');
    }
    var timeagoInstance;
    if(currDate){
        invariant(regexDate.test(currDate),'error')
        timeagoInstance= new timeago(currDate);
    }else {
